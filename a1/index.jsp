...
<!-- can also find path like this...<a href="${pageContext.request.contextPath}${'/a5/index.jsp'}">A5</a> -->
	...
	<div class="container">
		<div class="starter-template">
					...
					<img src="img/HelloWorld.png" class="img-responsive center-block" alt="JDK Installation" />

					<br /> <br />
					<b>Tomcat Installation:</b><br />
					<img src="img/ApacheTomcat.png" class="img-responsive center-block" alt="Tomcat Installation" />
